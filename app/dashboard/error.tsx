        ...
        <div className="mt-6 space-y-4">
          <div className="space-y-3">
            ...
            <h1 className="text-3xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50 sm:text-4xl">
              We hit a problem while loading your portfolio workspace.
            </h1>
          </div>

          <p className="text-base leading-8 text-zinc-600 dark:text-zinc-300">
            Try reloading the dashboard segment. If the issue persists, return to the landing page and start the flow again.
          </p>
