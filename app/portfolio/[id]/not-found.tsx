...
export default function PortfolioWorkspaceNotFound() {
  return (
        ...
        <div className="mt-6 space-y-4">
          <div className="space-y-3">
            ...
            <h1 className="text-3xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50 sm:text-4xl">
              We couldn&apos;t find a portfolio workspace for this id.
            </h1>
          </div>
          ...
          <p className="text-base leading-8 text-zinc-600 dark:text-zinc-300">
            ...
            not have enough saved data to build the owned workspace yet.
          </p>
        </div>
