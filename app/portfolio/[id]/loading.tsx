export default function PortfolioWorkspaceLoading() {
  return (
        ...
        <div className="animate-pulse space-y-8">
          <div className="flex flex-col gap-6 xl:flex-row xl:justify-between">
            <div className="space-y-4">
              <div className="h-7 w-48 rounded-full bg-zinc-200 dark:bg-zinc-800" />
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                {Array.from({ length: 6 }).map((_, index) => (
                  <div
                    key={index}
                    className="h-10 w-24 rounded-full bg-zinc-200 dark:bg-zinc-800"
                  />
                ))}
              </div>
            </div>
